...
urlpatterns = [
    ...
    path(
        "recipes/api/v1/", views.RecipeListViewHomeApi.as_view(), name="recipe_api_v1"
    ),
    path(
    ...
    path(
        ...
        views.RecipeAPIv2ViewSet.as_view({"get": "retrieve", "patch": "partial_update", 'delete':'destroy'}),
